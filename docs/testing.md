...
Session state comes from `herdr session list --json`; PTY output and fresh shell markers verify terminal handoff and input. Checks wait for observed conditions with deadlines, without automatic retries or full-screen snapshots.
